...
| Direct OpenAI Responses before GPT-5.6 | Implicit prefix caching with a stable prompt-cache key.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Optional `24h` retention only for allowlisted model families.                                                                                                                                 | Cached input and cache-write tokens are normalized when reported.                                         |
