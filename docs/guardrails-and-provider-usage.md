...
Unknown quota values render as `Not reported`, and unreported steps, reasoning, cache reads, token totals, and report costs render as `-`; they are never rendered as zero.
