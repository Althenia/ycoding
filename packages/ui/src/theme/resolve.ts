import type { ColorValue, ThemeDefinition, HexColor, ResolvedTheme, ThemeVariant } from "./types"
...
export function resolveTheme(theme: ThemeDefinition): { light: ResolvedTheme; dark: ResolvedTheme } {
  return {
