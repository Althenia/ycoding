import type { ThemeDefinition, ResolvedTheme, ResolvedV2Theme } from "./types"
import { resolveThemeVariant, themeToCss } from "./resolve"
import { resolveThemeVariantV2, themeV2ToCss } from "./v2/resolve"

let activeTheme: ThemeDefinition | null = null
const THEME_STYLE_ID = "ycoding-theme"
...
export function applyTheme(theme: ThemeDefinition, themeId?: string): void {
  activeTheme = theme
...
function buildThemeCss(
  ...
  const isDefaultTheme = themeId === "yc-2"
