...
import type { ThemeDefinition, HexColor, ResolvedV2Theme, ThemeVariant, V2ColorValue } from "../types"
...
export function resolveThemeV2(theme: ThemeDefinition): { light: ResolvedV2Theme; dark: ResolvedV2Theme } {
  return {
