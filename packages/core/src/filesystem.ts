...
import { Entry, FileSystem, FindInput, Match } from "@ycoding-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@ycoding-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@ycoding/v2/FileSystem") {}
