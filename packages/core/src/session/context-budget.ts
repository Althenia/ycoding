...
// The registry supplies real context/output limits per model; compaction reserves only its
// configured safety margin so its threshold matches the displayed model context window.
