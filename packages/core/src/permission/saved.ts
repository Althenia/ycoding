...
import { PermissionSaved } from "@ycoding-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@ycoding/v2/PermissionSaved") {}
