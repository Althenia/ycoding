...
import type { Data, Definition, Payload } from "@ycoding-ai/schema/event"
...
import { Durable } from "@ycoding-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@ycoding-ai/schema/event").ID
export const Seq = Event.Seq
export type Seq = import("@ycoding-ai/schema/event").Seq
export const Version = Event.Version
export type Version = import("@ycoding-ai/schema/event").Version
export type { Data, Definition, Payload } from "@ycoding-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@ycoding/Event") {}
