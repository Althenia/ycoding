...
import { ShellSelect } from "@ycoding-ai/core/shell/select"
import { FSUtil } from "@ycoding-ai/core/fs-util"
import { which } from "@ycoding-ai/core/util/which"
...
describe("shell", () => {
  ...
  test("falls back when configured shell cannot be resolved", async () => {
    await withShell(undefined, async () => {
      ...
      expect(ShellSelect.preferred("ycoding-missing-shell")).toBe(preferred)
      expect(ShellSelect.acceptable("ycoding-missing-shell")).toBe(acceptable)
    })
  })
