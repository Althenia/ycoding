...
import { NonNegativeInt } from "@ycoding-ai/schema/schema"
import { Vcs } from "@ycoding-ai/schema/vcs"
...
export const VcsGroup = HttpApiGroup.make("server.vcs")
  ...
  .add(
    HttpApiEndpoint.get("vcs.branch", "/api/vcs/branch", {
      query: LocationQuery,
      success: Location.response(Vcs.Branch),
    })
      .annotateMerge(locationQueryOpenApi)
      .annotateMerge(
        OpenApi.annotations({
