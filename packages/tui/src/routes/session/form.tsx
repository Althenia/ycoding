...
import type { FormField, FormValue } from "@ycoding-ai/client"
...
function requestOptions(form: FormWithLocation) {
  ...
  return {
    headers: {
      "x-ycoding-directory": encodeURIComponent(form.location.directory),
      ...(form.location.workspaceID ? { "x-ycoding-workspace": form.location.workspaceID } : {}),
    },
  }
}
