...
const MODE = { key: "ycoding.mode", base: "base" } as const
...
export type { KeymapCommand, KeymapLayer } from "@ycoding-ai/plugin/tui/context"
...
function useCommands(): Accessor<readonly KeymapCommand[]> {
  ...
  return useKeymapSelector((keymap) =>
    keymap
      ...
      .map((entry) => {
        const command = entry.command.ycoding ?? {
