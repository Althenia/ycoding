// Shared type vocabulary for the direct interactive mode (`ycoding mini`).
//
...
// Noninteractive JSON events use this transport shape; interactive Mini commits
// carry SessionMessageAssistantTool directly.
...
export type PermissionReply = Parameters<YCodingClient["permission"]["reply"]>[0]
