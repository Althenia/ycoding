// Top-level orchestrator for `ycoding mini`.
//
...
import type { LocationRef } from "@ycoding-ai/client/promise"
...
function formRequestOptions(location: LocationRef | undefined) {
  ...
  return {
    headers: {
      ...
      ...(location.workspaceID ? { "x-ycoding-workspace": location.workspaceID } : {}),
    },
  }
}
