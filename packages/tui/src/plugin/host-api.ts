...
import type { Info as TuiConfigInfo } from "../config"
...
type SdkConfig = TuiConfigInfo
type PluginOptions = Readonly<Record<string, unknown>>
type PluginConfig = { plugin?: ReadonlyArray<string | readonly [string, PluginOptions]> }
import type { YCodingEvent } from "@ycoding-ai/client/promise"
import type { PromptInput } from "@ycoding-ai/schema"
