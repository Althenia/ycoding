...
export const Info = Schema.Struct({
  ...
  session: Schema.optional(
    Schema.Struct({
      ...
      context_details: Schema.optional(Schema.Boolean).annotate({
        description: "Expand runtime-context notice details by default; false shows summaries only",
      }),
...
export function resolve(input: Info, options: { terminalSuspend: boolean }): Resolved {
  ...
  return {
    ...
    attention: {
      ...
      sound_pack: input.attention?.sound_pack ?? "ycoding.default",
