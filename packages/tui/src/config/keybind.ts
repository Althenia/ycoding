...
export const Definitions = {
  ...
  session_archive: keybind("ctrl+a", "Archive or unarchive session in the session list"),
  ...
  session_autonomy_normal: keybind("<leader>y", "Disable YOLO"),
  session_queued_prompts: keybind("<leader>q", "Manage queued prompts"),
  session_skill_conflict_resolve: keybind("<leader>i", "Resolve a session skill conflict"),
  ...
  shell_output_back: keybind("escape", "Go back from shell output"),
  shell_output_kill: keybind("ctrl+d", "Kill shell command from shell output"),
  ...
  variant_list: keybind("<leader>v", "List model variants"),
  ...
  messages_copy: keybind("<leader>o", "Copy message"),
...
export const CommandMap = {
  ...
  session_autonomy_normal: "session.autonomy.normal",
  session_queued_prompts: "session.queued_prompts",
  session_skill_conflict_resolve: "session.skill_conflict.resolve",
  ...
  shell_output_back: "shell-output.back",
  shell_output_kill: "shell-output.kill",
