...
const yoloGoal: SessionAutonomyState = { mode: "normal", yolo: true, goal: { runID: "run_session_transcript_live_fixes_fixture", text: "Keep todos in the sidebar", status: "active", iteration: 1, noProgress: 0, maxNoProgress: 5 },
}
