  ...
  const cases = [
    ...
    { name: "YOLO 2", autonomy: { mode: "normal", yolo: 2 }, expected: "enforced" },
    {
      ...
      autonomy: {
        mode: "normal",
        yolo: 2,
        goal: { runID: "run_session_rail_section_fixture", text: "Ship safely", status: "active", iteration: 1, noProgress: 0, maxNoProgress: 3 },
      },
      expected: "enforced",
    },
...
test("renders compact operational rail summaries from live component state", async () => {
  ...
  const autonomy: SessionAutonomyState = { mode: "normal", yolo: true, goal: { runID: "run_session_rail_section_fixture", text: "Ship summaries", status: "active", iteration: 1, noProgress: 0, maxNoProgress: 5 },
  }
...
test("renders distinct GOAL and AUTONOMY sections, SUBAGENTS and SHELLS rail rows, and a TODO LIST in the correct order", async () => {
  ...
  const autonomy: SessionAutonomyState = { mode: "normal", yolo: true, goal: {
      runID: "run_session_rail_section_fixture",
