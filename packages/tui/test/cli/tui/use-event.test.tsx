...
import type { YCodingClient, YCodingEvent } from "@ycoding-ai/client"
...
function vcs(branch: string): YCodingEvent {
  return {
    id: `evt_vcs_${branch}`,
    created: 0,
...
function update(version: string): YCodingEvent {
  return {
