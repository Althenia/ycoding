...
- Effect plugins import `@ycoding-ai/plugin/effect`, not `@ycoding-ai/core`.
- Public domain values use `@ycoding-ai/schema` contracts and generated `@ycoding-ai/client` types.
...
- Define `PluginHost` domain capabilities in `@ycoding-ai/plugin/effect`.
