...
describe("public import boundaries", () => {
  test("isolates each public entrypoint", async () => {
    const root = await bundleInputs("@ycoding-ai/client", "browser")
    ...
    const network = await bundleInputs("@ycoding-ai/client/effect", "browser")
    ...
    const promiseService = await bundleInputs("@ycoding-ai/client/service", "bun")
    ...
    const effectService = await bundleInputs("@ycoding-ai/client/effect/service", "bun")
