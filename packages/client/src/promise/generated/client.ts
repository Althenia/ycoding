import type {
  ...
  GuardrailStatusInput,
  GuardrailStatusOutput,
  GuardrailRequestListInput,
  GuardrailRequestListOutput,
  GuardrailRequestReplyInput,
  GuardrailRequestReplyOutput,
  MessageListInput,
  MessageListOutput,
  ModelListInput,
  ModelListOutput,
  ...
  ProjectArtifactArtifactListOutput,
  ProjectArtifactArtifactGetInput,
  ProjectArtifactArtifactGetOutput,
  ProjectArtifactArtifactCreateInput,
  ProjectArtifactArtifactCreateOutput,
  ProjectArtifactArtifactUpdateInput,
  ProjectArtifactArtifactUpdateOutput,
  ProjectArtifactArtifactGlobalConfirmInput,
  ProjectArtifactArtifactGlobalConfirmOutput,
  ProjectArtifactArtifactDisableInput,
  ProjectArtifactArtifactDisableOutput,
  ProjectArtifactArtifactEnableInput,
  ProjectArtifactArtifactEnableOutput,
  ProjectArtifactArtifactRemoveInput,
  ProjectArtifactArtifactRemoveOutput,
  ProjectArtifactArtifactRestoreInput,
  ProjectArtifactArtifactRestoreOutput,
  ProjectArtifactArtifactRevertInput,
  ProjectArtifactArtifactRevertOutput,
  ProjectArtifactArtifactMetricsInput,
  ProjectArtifactArtifactMetricsOutput,
  ProjectArtifactArtifactPromotionPreviewInput,
  ProjectArtifactArtifactPromotionPreviewOutput,
  ProjectArtifactArtifactPromotionConfirmInput,
  ProjectArtifactArtifactPromotionConfirmOutput,
  ProjectArtifactArtifactForkPreviewInput,
  ProjectArtifactArtifactForkPreviewOutput,
  ProjectArtifactArtifactForkConfirmInput,
  ProjectArtifactArtifactForkConfirmOutput,
  ProjectArtifactArtifactShadowPreviewInput,
  ProjectArtifactArtifactShadowPreviewOutput,
  ProjectArtifactArtifactShadowConfirmInput,
...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    session: {
      ...
      skills: (input: SessionSkillsInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: SessionSkillsOutput }>(
          {
            method: "GET",
            path: `/api/session/${encodeURIComponent(input.sessionID)}/skills`,
            successStatus: 200,
            declaredStatuses: [404, 400, 401],
            empty: false,
          },
    ...
    guardrail: {
      status: (input: GuardrailStatusInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: GuardrailStatusOutput }>(
          {
            method: "GET",
            path: `/api/session/${encodeURIComponent(input.sessionID)}/guardrail`,
            successStatus: 200,
            declaredStatuses: [404, 400, 401],
            empty: false,
          },
      ...
      request: {
        list: (input: GuardrailRequestListInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: GuardrailRequestListOutput }>(
            {
              method: "GET",
              path: `/api/session/${encodeURIComponent(input.sessionID)}/guardrail/request`,
              successStatus: 200,
              declaredStatuses: [404, 400, 401],
              empty: false,
            },
        ...
        reply: (input: GuardrailRequestReplyInput, requestOptions?: RequestOptions) =>
          request<GuardrailRequestReplyOutput>(
            {
              method: "POST",
              path: `/api/session/${encodeURIComponent(input.sessionID)}/guardrail/request/${encodeURIComponent(input.requestID)}/reply`,
    ...
    projectArtifact: {
      artifact: {
        list: (input: ProjectArtifactArtifactListInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactListOutput }>(
            {
              method: "GET",
              path: `/api/artifact`,
              query: { location: input["location"], scope: input["scope"], kind: input["kind"], stage: input["stage"] },
              successStatus: 200,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: false,
            },
            requestOptions,
          ).then((value) => value.data),
        get: (input: ProjectArtifactArtifactGetInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactGetOutput }>(
            {
              method: "GET",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}`,
              query: { location: input["location"] },
              successStatus: 200,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: false,
        ...
        create: (input: ProjectArtifactArtifactCreateInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactCreateOutput }>(
            {
              method: "POST",
              path: `/api/artifact`,
              query: { location: input["location"] },
              body: { scope: input["scope"], id: input["id"], definition: input["definition"] },
              successStatus: 200,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: false,
            },
        ...
        update: (input: ProjectArtifactArtifactUpdateInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactUpdateOutput }>(
            {
              method: "PUT",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}`,
              query: { location: input["location"] },
        ...
        global: {
          confirm: (input: ProjectArtifactArtifactGlobalConfirmInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactGlobalConfirmOutput }>(
              {
                method: "POST",
                path: `/api/artifact/global/confirm`,
                query: { location: input["location"] },
        ...
        disable: (input: ProjectArtifactArtifactDisableInput, requestOptions?: RequestOptions) =>
          request<ProjectArtifactArtifactDisableOutput>(
            {
              method: "POST",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/disable`,
              query: { location: input["location"] },
              body: {
                expectedRevision: input["expectedRevision"],
                expectedVersionID: input["expectedVersionID"],
        ...
        enable: (input: ProjectArtifactArtifactEnableInput, requestOptions?: RequestOptions) =>
          request<ProjectArtifactArtifactEnableOutput>(
            {
              method: "POST",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/enable`,
              query: { location: input["location"] },
              body: {
                expectedRevision: input["expectedRevision"],
                expectedVersionID: input["expectedVersionID"],
        ...
        remove: (input: ProjectArtifactArtifactRemoveInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactRemoveOutput }>(
            {
              method: "DELETE",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}`,
              query: { location: input["location"] },
        ...
        restore: (input: ProjectArtifactArtifactRestoreInput, requestOptions?: RequestOptions) =>
          request<ProjectArtifactArtifactRestoreOutput>(
            {
              method: "POST",
              path: `/api/artifact/trash/${encodeURIComponent(input.deletionID)}/restore`,
              query: { location: input["location"] },
              successStatus: 204,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: true,
        ...
        revert: (input: ProjectArtifactArtifactRevertInput, requestOptions?: RequestOptions) =>
          request<ProjectArtifactArtifactRevertOutput>(
            {
              method: "POST",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/revert`,
              query: { location: input["location"] },
              body: {
                expectedRevision: input["expectedRevision"],
                expectedVersionID: input["expectedVersionID"],
        ...
        metrics: (input: ProjectArtifactArtifactMetricsInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactMetricsOutput }>(
            {
              method: "GET",
              path: `/api/artifact/${encodeURIComponent(input.scope)}/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/metrics`,
              query: { location: input["location"] },
              successStatus: 200,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: false,
        ...
        promotion: {
          preview: (input: ProjectArtifactArtifactPromotionPreviewInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactPromotionPreviewOutput }>(
              {
                method: "POST",
                path: `/api/artifact/project/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/promotion`,
                query: { location: input["location"] },
                body: {
                  expectedRevision: input["expectedRevision"],
                  expectedVersionID: input["expectedVersionID"],
          ...
          confirm: (input: ProjectArtifactArtifactPromotionConfirmInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactPromotionConfirmOutput }>(
              {
                method: "POST",
                path: `/api/artifact/project/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/promotion/${encodeURIComponent(input.token)}/confirm`,
                query: { location: input["location"] },
                successStatus: 200,
                declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
                empty: false,
        ...
        fork: {
          preview: (input: ProjectArtifactArtifactForkPreviewInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactForkPreviewOutput }>(
              {
                method: "POST",
                path: `/api/artifact/global/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/fork`,
                query: { location: input["location"] },
                body: {
                  expectedRevision: input["expectedRevision"],
                  expectedVersionID: input["expectedVersionID"],
          ...
          confirm: (input: ProjectArtifactArtifactForkConfirmInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactForkConfirmOutput }>(
              {
                method: "POST",
                path: `/api/artifact/global/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/fork/${encodeURIComponent(input.token)}/confirm`,
                query: { location: input["location"] },
                successStatus: 200,
                declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
                empty: false,
        ...
        shadow: {
          preview: (input: ProjectArtifactArtifactShadowPreviewInput, requestOptions?: RequestOptions) =>
            request<{ readonly data: ProjectArtifactArtifactShadowPreviewOutput }>(
              {
                method: "POST",
                path: `/api/artifact/project/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/shadow`,
                query: { location: input["location"] },
                body: {
                  expectedRevision: input["expectedRevision"],
                  expectedVersionID: input["expectedVersionID"],
          ...
          confirm: (input: ProjectArtifactArtifactShadowConfirmInput, requestOptions?: RequestOptions) =>
            request<ProjectArtifactArtifactShadowConfirmOutput>(
              {
                method: "POST",
                path: `/api/artifact/project/${encodeURIComponent(input.kind)}/${encodeURIComponent(input.id)}/shadow/${encodeURIComponent(input.token)}/confirm`,
                query: { location: input["location"] },
                successStatus: 204,
                declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
                empty: true,
        ...
        purge: (input?: ProjectArtifactArtifactPurgeInput, requestOptions?: RequestOptions) =>
          request<{ readonly data: ProjectArtifactArtifactPurgeOutput }>(
            {
              method: "POST",
              path: `/api/artifact/trash/purge`,
              query: { location: input?.["location"] },
              successStatus: 200,
              declaredStatuses: [400, 404, 409, 410, 413, 429, 503, 401],
              empty: false,
