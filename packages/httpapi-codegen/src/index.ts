...
function renderEffectShape(groups: ReadonlyArray<Group>, options: { readonly module: string; readonly api: string }) {
  ...
  return `// Generated by @ycoding-ai/httpapi-codegen. Do not edit.
