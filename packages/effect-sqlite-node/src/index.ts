...
export const TypeId: TypeId = "~@ycoding-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@ycoding-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@ycoding-ai/effect-sqlite-node/NodeSqliteClient")
