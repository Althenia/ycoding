...
import { registerYCodingSpinner } from "@ycoding-ai/tui/component/register-spinner"
import { SPINNER_FRAMES } from "@ycoding-ai/tui/component/spinner"
import { go } from "@ycoding-ai/tui/logo"
...
const stages = ["Keeping your session safe", "Starting the new background service", "Loading YCoding"] as const
...
function UpdateFooter(props: {
  ...
  const pausedHeader = phrase(["YCoding", colors.muted, true], ["update paused", colors.muted])
  const outcomeStatus = () =>
