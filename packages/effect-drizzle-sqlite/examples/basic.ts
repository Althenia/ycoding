...
class Database extends Context.Service<Database, DatabaseShape>()("@ycoding/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@ycoding/example/UserStore") {
