...
Kit and Aidan want provider-specific LLM behavior to move out of ycoding's AI
...
ycoding's dynamic runtime should construct executable models at its app
...
- Effect AI: executable models carry provider requirements and can be resolved by
  an app boundary.
- LiteLLM/ycoding config: dynamic `providerID/modelID` branching belongs at the
