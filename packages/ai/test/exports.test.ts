...
import {
  ...
  OpenRouter,
  XAI,
} from "@ycoding-ai/ai/providers"
import * as GitHubCopilot from "@ycoding-ai/ai/providers/github-copilot"
import { OpenAIChat, OpenAICompatibleChat, OpenAICompatibleResponses, OpenAIResponses } from "@ycoding-ai/ai/protocols"
...
describe("public exports", () => {
  ...
  test("provider barrels expose user-facing facades", async () => {
    const { OpenAICompatibleResponses } = await import("@ycoding-ai/ai/providers")
