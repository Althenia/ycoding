...
import { ToolContent, ToolFileContent, ToolTextContent } from "@ycoding-ai/schema/llm"
...
export class Message extends Schema.Class<Message>("LLM.Message")({
  ...
  // Request-only message, regenerated on every request from live state. Cache
  // placement must never mark it, since a cached prefix containing volatile
  // text is invalidated by any state change.
