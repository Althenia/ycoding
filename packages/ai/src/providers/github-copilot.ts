...
// GitHub Copilot has no canonical public URL — callers (ycoding, etc.) must
...
const chatRoute = OpenAIChat.route.with({ id: "github-copilot-chat", provider: id })
const responsesRoute = OpenAIResponses.route.with({ id: "github-copilot-responses", provider: id })
