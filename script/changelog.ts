...
Generates UPCOMING_CHANGELOG.md by running the ycoding changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for ycoding run (default: low)
      --quiet            Suppress ycoding command output unless it fails
